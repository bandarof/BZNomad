    ...
    extend: {
      ...
      keyframes: {
        ...
        carousel: {
          ...
          '42.86%': { transform: 'translateX(-200%)' },
          '42.87%': { transform: 'translateX(-300%)' },
          '57.15%': { transform: 'translateX(-300%)' },
          '57.16%': { transform: 'translateX(-400%)' },
          '71.44%': { transform: 'translateX(-400%)' },
          '71.45%': { transform: 'translateX(-500%)' },
          '85.73%': { transform: 'translateX(-500%)' },
